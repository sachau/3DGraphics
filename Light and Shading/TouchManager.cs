...
Description: This class takes handles all the transformation of the 
             ...
             and shear the GameObject. It will also set the transparency level
*/
using UnityEngine;
...
public class TouchManager : MonoBehaviour {
   ...
   */
    ...
    /**
   *   Set Transparency with an alpha value of .3
   */
    public void Transparent3(GameObject shape)
    {
        shape.GetComponent<Renderer>().material.color = new Color(0.3f, 0.3f, 0.3f, 0.3f);
    }

    /**
   *   Set Transparency with an alpha value of .6
   */
    public void Transparent6(GameObject shape)
    {
        shape.GetComponent<Renderer>().material.color = new Color(0.6f, 0.6f, 0.6f, 0.6f);
    }

    /**
   *   Set Transparency with an alpha value of 1 
   *   Resents the transparency. 
   */
    public void ResetTransparent(GameObject shape)
    {
        shape.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 1f);
    }
}
